        ...
        <div className="flex flex-col items-center">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-glow mb-6">
              Elevate Your <span className="text-blue-500">Web</span> Experience
            </h1>
            
            <p className="text-xl text-gray-700 mb-8">
              Professional full-stack web development solutions that bring your vision to life.
              From personal websites to enterprise applications, we deliver exceptional digital experiences.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/services"
                className="bg-transparent border border-blue-500 text-blue-500 hover:bg-blue-500/10 font-medium py-3 px-8 rounded-lg transition-all duration-300 flex items-center justify-center"
              >
                Our Services
              </Link>
            </div>
