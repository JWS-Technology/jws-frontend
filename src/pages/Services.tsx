...
import { Code, Database, Globe, Layout, LifeBuoy, Layers, Monitor, RefreshCw, Server, Shield } from "lucide-react";
const Services = () => {
  const services = [{
    id: "web-development",
    title: "Custom Web App Development",
    description: "We create tailored web applications that perfectly match your business requirements. From simple websites to complex applications, our solutions are built with scalability and maintainability in mind.",
    icon: Code,
    features: ["Responsive and mobile-first design", "Interactive user interfaces", "Performance optimization", "Cross-browser compatibility"]
  }, {
    id: "architecture",
    title: "Frontend & Backend Architecture",
    description: "Our architectural approach ensures your application is built on solid foundations. We design robust systems that can scale with your business growth and adapt to changing requirements.",
    icon: Layers,
    features: ["Scalable architecture design", "Code organization and structure", "State management solutions", "Database schema design"]
  }, {
    id: "api-development",
    title: "API Development & Integration",
    description: "We build reliable APIs that connect your application with external services and data sources. Our integration services ensure smooth data flow between different parts of your system.",
    icon: Server,
    features: ["RESTful API design", "Third-party API integration", "API documentation", "Authentication and security"]
  }, {
    id: "maintenance",
    title: "Maintenance & Performance Optimization",
    description: "Keep your application running smoothly with our maintenance services. We optimize performance, fix bugs, and update your application to ensure it remains secure and efficient.",
    icon: RefreshCw,
    features: ["Regular updates and patches", "Performance monitoring", "Bug fixing and troubleshooting", "Security audits"]
  }, {
    id: "ui-design",
    title: "UI/UX Design",
    description: "Create intuitive and engaging user experiences that delight your customers. Our design approach focuses on both aesthetics and usability to create interfaces that are both beautiful and functional.",
    icon: Layout,
    features: ["User-centered design", "Wireframing and prototyping", "Visual design", "Usability testing"]
  }, {
    id: "consulting",
    title: "Technical Consulting",
    description: "Get expert advice on your technical challenges. Our consulting services help you make informed decisions about technology choices, architecture, and development strategies.",
    icon: LifeBuoy,
    features: ["Technology stack recommendations", "Code reviews", "Architecture evaluation", "Best practices guidance"]
  }];
          ...
          <div className="grid gap-16">
            ...
            margin: "-100px"
                ...
                <div className={`${index % 2 === 1 ? "md:order-1" : ""}`}>
                  <div className="bg-blue-50 p-6 h-full flex flex-col justify-center py-[136px] rounded-xl">
      ...
      <section className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.p className="text-xl mb-8 opacity-90" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <Link to="/contact" className="bg-white text-blue-700 px-8 py-3 rounded-md font-bold hover:bg-blue-50 transition-colors inline-block hover:shadow-glow-white">
                Get in Touch
              </Link>
              <Link to="/projects" className="border-2 border-white text-white px-8 py-3 rounded-md font-bold hover:bg-white/10 transition-colors inline-block">
                View Our Work
              </Link>
            </motion.div>
          </div>
